...
export function renderOrderSummary() {
              ...
              <div class="cart-item-details-grid">
                ...
                <div class="cart-item-details">
                  ...
                  <div class="product-quantity">
                    ...
                    <input class="quantity-input js-quantity-input-${matchingProduct.id} is-editing-quantity" type="number">
                    <span class="save-quantity-link link-primary is-editing-quantity js-save-link-${matchingProduct.id}">Save</span>
  ...
  function deliveryOptionsHTML(matchingProduct, cartItem) {
    ...
    deliveryOptions.forEach((deliveryOption) => {
      ...
      const priceString = deliveryOption.priceCents === 0 ? 'FREE' : `$${formatCurrnecy(deliveryOption.priceCents)} -`;
  ...
  document.querySelectorAll('.js-update-link').forEach((updateLink) => {
    updateLink.addEventListener('click', () => {
      ...
      quantityLable.style.display = 'none';
      ...
      saveLink.addEventListener('click', () => {
        ...
        quantityLable.innerHTML =matchingItem.quantity
        quantityLable.style.display = 'initial';
